...
class ForumComment : AppCompatActivity() {
    ...
    private fun uploadImageToFirebase(imageUri: Uri, amount: String) {
        ...
        val transparencyImageRef = FirebaseDatabase.getInstance().getReference("Forum Post").child(key).child("TransparencyImage").child(currentUserUid)
                ...
                if (!contributionStatus) {
                    ...
                    fileRef.putFile(imageUri)
                                ...
                                transparencyImageRef.child("contributionStatus").addValueEventListener(object : ValueEventListener {
                                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                                        ...
                                        if (contributionStatus) {
                                            ...
                                            val participantsRef = FirebaseDatabase.getInstance().getReference("Forum Post").child(key)
                        ...
                        .addOnFailureListener { exception ->
                            ...
                            Toast.makeText(this@ForumComment, "Image upload failed: ${exception.message}", Toast.LENGTH_SHORT).show()
                        }
                }
            }
    ...
    private fun incrementActivePointsForUser(uid: String) {
        ...
        FirebaseDatabase.getInstance().getReference("Forum Post").child(key).child("activepoints")
            ...
            participantsReference.setValue(false)
                .addOnSuccessListener {
                    ...
                    participantsReference.addValueEventListener(object : ValueEventListener {
                        ...
                        override fun onCancelled(databaseError: DatabaseError) {
                            // Handle onCancelled
                            Toast.makeText(this@ForumComment, "Failed to join: ${databaseError.message}", Toast.LENGTH_SHORT).show()
                        }
                    })
                }
                .addOnFailureListener { exception ->
                    // Handle the failure to set to false
                    Toast.makeText(this@ForumComment, "Failed to join: ${exception.message}", Toast.LENGTH_SHORT).show()
                }
