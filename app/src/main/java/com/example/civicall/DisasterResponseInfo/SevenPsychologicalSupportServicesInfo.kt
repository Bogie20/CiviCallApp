...
import com.example.civicall.databinding.ActivitySevenPsychologicalSupportServicesInfoBinding

class SevenPsychologicalSupportServicesInfo : AppCompatActivity() {
    private lateinit var binding:ActivitySevenPsychologicalSupportServicesInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivitySevenPsychologicalSupportServicesInfoBinding.inflate(layoutInflater)
