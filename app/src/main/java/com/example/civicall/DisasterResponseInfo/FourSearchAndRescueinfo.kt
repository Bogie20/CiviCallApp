...
import com.example.civicall.databinding.ActivityFourSearchAndRescueBinding

class FourSearchAndRescueinfo : AppCompatActivity() {
    private lateinit var binding:ActivityFourSearchAndRescueBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFourSearchAndRescueBinding.inflate(layoutInflater)
