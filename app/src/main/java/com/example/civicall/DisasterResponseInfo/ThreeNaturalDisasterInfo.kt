...
import com.example.civicall.databinding.ActivityThreeNaturalDisasterInfoBinding

class ThreeNaturalDisasterInfo : AppCompatActivity() {
    private lateinit var binding:ActivityThreeNaturalDisasterInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityThreeNaturalDisasterInfoBinding.inflate(layoutInflater)
