...
import com.example.civicall.databinding.ActivityOneFirstAidInfoBinding

class OneFirstAidInfo : AppCompatActivity() {
    private lateinit var binding:ActivityOneFirstAidInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityOneFirstAidInfoBinding.inflate(layoutInflater)
