...
import com.example.civicall.databinding.ActivityFiveCommunicationAndInformationInfoBinding

class FiveCommunicationAndInformationInfo : AppCompatActivity() {
    private lateinit var binding:ActivityFiveCommunicationAndInformationInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFiveCommunicationAndInformationInfoBinding.inflate(layoutInflater)
