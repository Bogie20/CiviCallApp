...
class FoodDistributionAndNutrionInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(
            DataItem("Plan for mass food distribution points.",
        ...
        dataList.add(
            DataItem("Consider dietary restrictions and allergies.",
        ...
        dataList.add(
            DataItem("Ensure food safety and sanitation.",
        ...
        dataList.add(
            DataItem("Train food handling personnel.",
        ...
        dataList.add(
            DataItem("Monitor food quality and expiration dates.  ",
        ...
        dataList.add(
            DataItem("Collaborate with food banks and suppliers.",
        ...
        dataList.add(
            DataItem("Promote breastfeeding and infant nutrition.",
        ...
        dataList.add(
            DataItem("Address malnutrition concerns.",
        ...
        dataList.add(
            DataItem("Provide clean drinking water.",
