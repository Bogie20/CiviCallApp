...
import com.example.civicall.databinding.ActivityZeroEmergencyPreparednessInfoBinding

class ZeroEmergencyPreparednessInfo : AppCompatActivity() {
    private lateinit var binding:ActivityZeroEmergencyPreparednessInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityZeroEmergencyPreparednessInfoBinding.inflate(layoutInflater)
