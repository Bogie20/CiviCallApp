...
import com.example.civicall.databinding.ActivityTwoAdmissionBinding

class TwoAdmission : AppCompatActivity() {
    private lateinit var binding:ActivityTwoAdmissionBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityTwoAdmissionBinding.inflate(layoutInflater)
