...
import com.example.civicall.databinding.ActivityFourStudentInitiativesBinding


class FourStudentInitiatives : AppCompatActivity() {
    private lateinit var binding:ActivityFourStudentInitiativesBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFourStudentInitiativesBinding.inflate(layoutInflater)
