...
import com.example.civicall.databinding.ActivityEightStudentDevelopmentBinding

class EightStudentDevelopment : AppCompatActivity() {
    private lateinit var binding:ActivityEightStudentDevelopmentBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityEightStudentDevelopmentBinding.inflate(layoutInflater)
