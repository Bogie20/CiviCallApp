...
import com.example.civicall.databinding.ActivityNineSustainabilityBinding


class NineSustainability : AppCompatActivity() {
    private lateinit var binding:ActivityNineSustainabilityBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityNineSustainabilityBinding.inflate(layoutInflater)
