        ...
        val adapter = CivicAdapterMain(campusList) { position ->
            ...
            when (position) {
                0 -> {
                    ...
                    val intent = Intent(this, AmplifyingStudentVoicesInfo::class.java)
                    startActivity(intent)
                }

                1 -> {
                    // Handle click for Item 1
                    val intent = Intent(this, DigitalToolsforCivicEngagementInfo::class.java)
                    startActivity(intent)
                }

                2 -> {
                    // Handle click for Item 2
                    val intent = Intent(this, GlobalCitizenshipInfo::class.java)
                    startActivity(intent)
                }

                3 -> {
                    // Handle click for Item 3
                    val intent = Intent(this, SkillsandOpportunitiesinfo::class.java)
                    startActivity(intent)
                }

                4 -> {
                    // Handle click for Item 4
                    val intent = Intent(this, ChampionsofSocialJusticeInfo::class.java)
                    startActivity(intent)
                }

                5 -> {
                    // Handle click for Item 5
                    val intent = Intent(this, CivicParticipationInfo::class.java)
                    startActivity(intent)
                }

                6 -> {
                    // Handle click for Item 6
                    val intent = Intent(this, StudentLeadershipInfo::class.java)
                    startActivity(intent)
                }

                7 -> {
                    // Handle click for Item 7
                    val intent = Intent(this, CivicAdvocacyStrategiesInfo::class.java)
                    startActivity(intent)
                }
                ...
                9 -> {
                    ...
                    val intent = Intent(this, SustainabilityInitiativesInfo::class.java)
                    startActivity(intent)
                }
