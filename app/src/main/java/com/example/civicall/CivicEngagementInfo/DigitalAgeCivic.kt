...
class DigitalAgeCivic : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(DataItem("1. Define Your Cause: Ignite Your Passion, Unleash Your Purpose",
        ...
        dataList.add(DataItem("6. Stay Informed: Navigating the Digital Tide of Information",
            ...
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("7. Collaborate with Influencers: Amplifying Impact Through Digital Alliances",
            "\"Identify and collaborate with social media influencers or activists who align with your cause and have an established following. Build genuine relationships with these influencers, and leverage their endorsement and support to amplify your campaign's reach and impact. Collaborations can include co-hosting live events, participating in joint campaigns, or featuring influencers in your content to reach new audiences effectively.\"    \n",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("8. Advocate Responsibly: Navigating Digital Activism with Integrity",
            "\"Uphold a respectful and constructive tone in your online interactions, even when engaging with individuals who hold opposing viewpoints. Constructive dialogue fosters a positive image for your cause and encourages open-mindedness among your audience. Implement moderation and content guidelines to maintain a safe and inclusive online environment that promotes productive discussions.\"\n",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("9. Mobilize for Action: Uniting Digital Voices for Real-world Change",
            "\"Encourage your followers to take concrete actions in support of your cause. Clearly outline the steps they can take, whether it's signing petitions, contacting elected officials, attending rallies or events, or making donations. Provide accessible resources, guides, and templates that simplify the process of engagement and empower your audience to contribute meaningfully to your advocacy.\"\n",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("10. Stay Resilient: Your Voice Matters",
            "\"Utilize the analytics tools available on social media platforms to monitor the performance of your advocacy campaigns. Analyze key metrics such as engagement rates, reach, click-through rates, and conversion rates to evaluate the effectiveness of your efforts. Regularly review your data insights to identify trends, strengths, and areas for improvement. Adjust your strategy based on these insights to maximize your impact and refine your approach over time.\"\n",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
