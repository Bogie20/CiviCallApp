...
import com.example.civicall.databinding.ActivityEightDigitalcivicBinding

class EightDigitalCivic : AppCompatActivity() {
    private lateinit var binding:ActivityEightDigitalcivicBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityEightDigitalcivicBinding.inflate(layoutInflater)
