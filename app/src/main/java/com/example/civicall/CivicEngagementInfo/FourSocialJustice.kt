...
import com.example.civicall.databinding.ActivityFoursocialjusticeBinding

class FourSocialJustice : AppCompatActivity() {
    private lateinit var binding:ActivityFoursocialjusticeBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFoursocialjusticeBinding.inflate(layoutInflater)
