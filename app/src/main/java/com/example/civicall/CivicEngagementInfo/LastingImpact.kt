...
class LastingImpact : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(DataItem("2. Join Student Organizations: Forge Lasting Bonds and Amplify Impact Through Campus Clubs",
            ...
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("3. Volunteer: Invest Your Time in Community Service for a Purposeful Contribution",
            ...
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("4. Advocate for Change: Be a Voice for Transformation through Advocacy, Lobbying, and Peaceful Protests",
            "Be a catalyst for change by advocating for issues you care about. Use your voice to raise awareness, engage in dialogue, and push for policy changes. Advocacy is a powerful tool for societal transformation; stand up for your beliefs and be the change you wish to see in the world.",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("5. Network: Cultivate Meaningful Relationships with Mentors, Professors, and Community Leaders to Fuel Your Initiatives  ",
            "Connect with mentors, professors, and community leaders for guidance in your civic engagement initiatives. Their experience and wisdom help you navigate social causes. Building a strong network provides resources and opportunities to elevate your efforts for lasting change.",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("6. Start Small: Begin Your Journey with Attainable Projects and Grow Your Impact Over Time",
            "Begin your civic engagement journey with smaller, passion-aligned projects to build experience and resilience. Learn from successes and setbacks to gain confidence and gradually take on larger initiatives. Remember, even significant movements start with a single step, so let dedication and determination guide your path toward lasting impact.",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("7. Use Social Media: Unleash the Potential of Online Platforms to Spark Awareness and Mobilize Action ",
            "Begin your civic engagement journey with smaller, passion-aligned projects to build experience and resilience. Learn from successes and setbacks to gain confidence and gradually take on larger initiatives. Remember, even significant movements start with a single step, so let dedication and determination guide your path toward lasting impact.",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("8. Attend Workshops and Conferences: Empower Your Journey with Expert Insights and Skills",
            "Enhance your civic engagement through relevant workshops and conferences. These events offer expert insights, valuable skills, and inspiration from like-minded peers and thought leaders. Embrace these opportunities for continuous growth, refining strategies, and making your initiatives more effective and sustainable on your journey to lasting impact.",
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("9. Collaborate: Join Forces with Local Businesses, Organizations, and Fellow Students to Magnify Your Influence",
