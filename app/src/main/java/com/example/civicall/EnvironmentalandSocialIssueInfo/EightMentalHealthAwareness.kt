...
import com.example.civicall.databinding.ActivityEightMentalHealthAwarenessBinding

class EightMentalHealthAwareness : AppCompatActivity() {
    private lateinit var binding:ActivityEightMentalHealthAwarenessBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityEightMentalHealthAwarenessBinding.inflate(layoutInflater)
