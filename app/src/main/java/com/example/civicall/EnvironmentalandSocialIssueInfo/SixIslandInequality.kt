...
import com.example.civicall.databinding.ActivitySixIslandInequalityBinding

class SixIslandInequality : AppCompatActivity() {
    private lateinit var binding:ActivitySixIslandInequalityBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivitySixIslandInequalityBinding.inflate(layoutInflater)
