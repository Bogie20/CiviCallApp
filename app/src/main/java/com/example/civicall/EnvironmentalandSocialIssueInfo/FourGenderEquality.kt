...
import com.example.civicall.databinding.ActivityFourGenderEqualityBinding

class FourGenderEquality : AppCompatActivity() {
    private lateinit var binding:ActivityFourGenderEqualityBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFourGenderEqualityBinding.inflate(layoutInflater)
