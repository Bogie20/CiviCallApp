...
import com.example.civicall.databinding.ActivitySevenRisingAwarenessBinding

class SevenRisingAwareness : AppCompatActivity() {
    private lateinit var binding:ActivitySevenRisingAwarenessBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivitySevenRisingAwarenessBinding.inflate(layoutInflater)
