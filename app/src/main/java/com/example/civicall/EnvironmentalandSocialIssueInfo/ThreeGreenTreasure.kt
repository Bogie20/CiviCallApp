...
import com.example.civicall.databinding.ActivityThreeGreenTreasureBinding

class ThreeGreenTreasure : AppCompatActivity() {
    private lateinit var binding:ActivityThreeGreenTreasureBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityThreeGreenTreasureBinding.inflate(layoutInflater)
