...
import com.example.civicall.databinding.ActivityFiveConservingBiodiversityBinding

class FiveConservingBiodiversity : AppCompatActivity() {
    private lateinit var binding:ActivityFiveConservingBiodiversityBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFiveConservingBiodiversityBinding.inflate(layoutInflater)
