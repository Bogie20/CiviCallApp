...
import com.example.civicall.databinding.ActivityZeroBreakingtheChainsBinding

class ZeroBreaktheChain : AppCompatActivity() {
    private lateinit var binding:ActivityZeroBreakingtheChainsBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityZeroBreakingtheChainsBinding.inflate(layoutInflater)
