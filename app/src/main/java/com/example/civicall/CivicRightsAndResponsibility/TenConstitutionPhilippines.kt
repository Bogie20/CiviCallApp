...
import com.example.civicall.databinding.ActivityTenArticleConstitutionBinding

class TenConstitutionPhilippines : AppCompatActivity() {
    private lateinit var binding:ActivityTenArticleConstitutionBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityTenArticleConstitutionBinding.inflate(layoutInflater)
        ...
        dataList.add(
            DataItem("THE 1987 CONSTITUTION OF THE REPUBLIC OF THE PHILIPPINES – ARTICLE II",
                ...
                "https://i.ytimg.com/vi/A73YuKbPEU4/maxresdefault.jpg",
