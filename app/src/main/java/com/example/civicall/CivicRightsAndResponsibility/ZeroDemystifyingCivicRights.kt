...
import com.example.civicall.databinding.ActivityZeroDemystifyingCivicRightsBinding

class ZeroDemystifyingCivicRights : AppCompatActivity() {
    private lateinit var binding:ActivityZeroDemystifyingCivicRightsBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityZeroDemystifyingCivicRightsBinding.inflate(layoutInflater)
