...
import com.example.civicall.databinding.ActivityFiveDigitalAgeBinding

class FiveDigitalAge : AppCompatActivity() {
    private lateinit var binding:ActivityFiveDigitalAgeBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFiveDigitalAgeBinding.inflate(layoutInflater)
