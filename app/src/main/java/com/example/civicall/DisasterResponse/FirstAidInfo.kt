...
class FirstAidInfo : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(DataItem("5. Wildfires: Spread and Defensible Spaces in Fire-Prone Areas",
            ...
            R.drawable.love2,
            "https://libguides.umn.edu/c.php?g=964128"))
        dataList.add(DataItem("6. Volcanic Eruptions: Signs, Safety, and Preparedness",
