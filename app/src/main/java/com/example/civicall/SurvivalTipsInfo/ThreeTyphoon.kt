...
import com.example.civicall.databinding.ActivityThreeTyphoonInfoBinding

class ThreeTyphoon : AppCompatActivity() {
    private lateinit var binding:ActivityThreeTyphoonInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityThreeTyphoonInfoBinding.inflate(layoutInflater)
