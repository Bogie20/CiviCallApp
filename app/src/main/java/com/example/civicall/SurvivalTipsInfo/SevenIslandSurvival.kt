...
import com.example.civicall.databinding.ActivitySevenIslandSurvivalInfoBinding

class SevenIslandSurvival : AppCompatActivity() {
    private lateinit var binding:ActivitySevenIslandSurvivalInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivitySevenIslandSurvivalInfoBinding.inflate(layoutInflater)
