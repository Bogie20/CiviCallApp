...
import com.example.civicall.databinding.ActivityZeroSurvivingEarthquakesBinding

class ZeroSurvivingEarthquakes : AppCompatActivity() {
    private lateinit var binding:ActivityZeroSurvivingEarthquakesBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityZeroSurvivingEarthquakesBinding.inflate(layoutInflater)
