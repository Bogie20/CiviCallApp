...
import com.example.civicall.databinding.ActivityFourElNinoInfoBinding

class FourElNino : AppCompatActivity() {
    private lateinit var binding:ActivityFourElNinoInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFourElNinoInfoBinding.inflate(layoutInflater)
