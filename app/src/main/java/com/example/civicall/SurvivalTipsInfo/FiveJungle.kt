...
import com.example.civicall.databinding.ActivityFiveJungleSurvivalInfoBinding

class FiveJungle : AppCompatActivity() {
    private lateinit var binding:ActivityFiveJungleSurvivalInfoBinding
    private lateinit var networkUtils: NetworkUtils
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        networkUtils = NetworkUtils(this)
        networkUtils.initialize()
        binding = ActivityFiveJungleSurvivalInfoBinding.inflate(layoutInflater)
